...
public class BettingSystem {
    public static void main(String[] args) {
        ...
        int MAX_PLAYERS = 100;
        int[][] betDetails = new int[30][MAX_PLAYERS]; // Store [day][player]: total bet amount
        int[][] betNumbers = new int[30][MAX_PLAYERS]; // Store [day][player]: bet number
        int[][] payouts = new int[30][MAX_PLAYERS];    // Store [day][player]: payout
        int dayCount = 1;
        int totalEarnings = 0;
        int totalPayouts = 0;
        int choice;
